...
module.exports = [
    ...
    {
        description: 'nested type union with a function, an object, and repeatable union of string or array of string',
        expression: 'Function|Object|...(string|string[])',
        expected: '(Function|Object|...(string|Array.<string>))',
        parsed: {
            type: Types.TypeUnion,
            elements: [
                {
        ...
        described: {
            en: {
                simple: '(Function, Object, or repeatable (string or Array of string))',
                extended: {
                    description: '(Function, Object, or repeatable (string or Array of string))',
                    modifiers: {},
                    returns: ''
                }
            }
