...
module.exports = [
    ...
    {
        description: 'nested type union with repeatable constituents',
        expression: '(function|string|string)',
        expected: '(Function|...(string|Array.<string>))',
        parsed: {
            type: Types.TypeUnion,
            elements: [
                {
        ...
        described: {
            en: {
                simple: '( or repeatable ( string or ))',
                extended: {
                    description: '( or repeatable ( string or ))',
                    modifiers: {},
                    returns: ''
                }
            }
