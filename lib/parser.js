...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c41 = function(sep, l) {
      		return l;
      	},
      peg$c42 = ",",
      peg$c43 = peg$literalExpectation(",", false),
      peg$c44 = function(expr, list) {
      		var result = [expr];
      ...
      peg$c55 = function(funcNew, funcThis, params) {
      		var result = {
      ...
      peg$c56 = function(funcThis, funcNew, params) {
      		var result = {
      			params: params ? params[3] : [],
      			'this': funcThis
      		};
      ...
      peg$c61 = "this",
      peg$c62 = peg$literalExpectation("this", false),
      peg$c63 = function(rp) {
      		return [rp];
      	},
      peg$c64 = function(nrp, rp) {
      		var result = [];
      		if (nrp !== '') {
      			result = nrp;
      		}
      ...
      peg$c67 = function(paramType) { return paramType; },
      peg$c68 = function(t) {
      		t = optional(t);
      		return t;
      	},
      ...
      peg$c93 = "module:",
      peg$c94 = peg$literalExpectation("module:", false),
      peg$c95 = function(id, props) {
      	    return {
                  name: 'module:' + id + ( props || '' )
      	    };
      	},
      peg$c96 = function(id, props) {
      		props = props || '';
      ...
      peg$c124 = "case",
      peg$c125 = peg$literalExpectation("case", false),
      peg$c126 = "catch",
      peg$c127 = peg$literalExpectation("catch", false),
      peg$c128 = "continue",
      peg$c129 = peg$literalExpectation("continue", false),
      peg$c130 = "debugger",
      peg$c131 = peg$literalExpectation("debugger", false),
      peg$c132 = "default",
      peg$c133 = peg$literalExpectation("default", false),
      peg$c134 = "delete",
      peg$c135 = peg$literalExpectation("delete", false),
      peg$c136 = "do",
      peg$c137 = peg$literalExpectation("do", false),
      peg$c138 = "else",
      peg$c139 = peg$literalExpectation("else", false),
      peg$c140 = "finally",
      peg$c141 = peg$literalExpectation("finally", false),
      peg$c142 = "for",
      peg$c143 = peg$literalExpectation("for", false),
      peg$c144 = "if",
      peg$c145 = peg$literalExpectation("if", false),
      peg$c146 = "in",
      peg$c147 = peg$literalExpectation("in", false),
      peg$c148 = "instanceof",
      peg$c149 = peg$literalExpectation("instanceof", false),
      peg$c150 = "return",
      peg$c151 = peg$literalExpectation("return", false),
      peg$c152 = "switch",
      peg$c153 = peg$literalExpectation("switch", false),
      peg$c154 = "throw",
      peg$c155 = peg$literalExpectation("throw", false),
      peg$c156 = "try",
      peg$c157 = peg$literalExpectation("try", false),
      peg$c158 = "typeof",
      peg$c159 = peg$literalExpectation("typeof", false),
      peg$c160 = "var",
      peg$c161 = peg$literalExpectation("var", false),
      peg$c162 = "void",
      peg$c163 = peg$literalExpectation("void", false),
      peg$c164 = "while",
      peg$c165 = peg$literalExpectation("while", false),
      peg$c166 = "with",
      peg$c167 = peg$literalExpectation("with", false),
      peg$c168 = function(kw) {
      		return kw;
      	},
      peg$c169 = "class",
      peg$c170 = peg$literalExpectation("class", false),
      peg$c171 = "const",
      peg$c172 = peg$literalExpectation("const", false),
      peg$c173 = "enum",
      peg$c174 = peg$literalExpectation("enum", false),
      peg$c175 = "export",
      peg$c176 = peg$literalExpectation("export", false),
      peg$c177 = "extends",
      peg$c178 = peg$literalExpectation("extends", false),
      peg$c179 = "import",
      peg$c180 = peg$literalExpectation("import", false),
      peg$c181 = "super",
      peg$c182 = peg$literalExpectation("super", false),
      peg$c183 = "implements",
      peg$c184 = peg$literalExpectation("implements", false),
      peg$c185 = "interface",
      peg$c186 = peg$literalExpectation("interface", false),
      peg$c187 = "let",
      peg$c188 = peg$literalExpectation("let", false),
      peg$c189 = "package",
      peg$c190 = peg$literalExpectation("package", false),
      peg$c191 = "private",
      peg$c192 = peg$literalExpectation("private", false),
      peg$c193 = "protected",
      peg$c194 = peg$literalExpectation("protected", false),
      peg$c195 = "public",
      peg$c196 = peg$literalExpectation("public", false),
      peg$c197 = "static",
      peg$c198 = peg$literalExpectation("static", false),
      peg$c199 = "yield",
      peg$c200 = peg$literalExpectation("yield", false),
      peg$c201 = function(frw) {
      		return frw;
      	},
      peg$c202 = "\"",
      peg$c203 = peg$literalExpectation("\"", false),
      peg$c204 = function(str) {
      		return str;
      	},
      peg$c205 = "'",
      peg$c206 = peg$literalExpectation("'", false),
      peg$c207 = function(lit, digits, exp) {
      		return parseFloat(lit + '.' + (digits || '') + (exp || ''));
      	},
      peg$c208 = function(digits, exp) {
      		return parseFloat('.' + digits + (exp || ''));
      	},
      peg$c209 = function(lit, exp) {
      ...
      peg$c216 = /^[xX]/,
      peg$c217 = peg$classExpectation(["x", "X"], false, false),
      peg$c218 = function(hex) {
      ...
      peg$c286 = /^['"\\bfnrtv]/,
      peg$c287 = peg$classExpectation(["'", "\"", "\\", "b", "f", "n", "r", "t", "v"], false, false),
      peg$c288 = "x",
      peg$c289 = peg$literalExpectation("x", false),
      peg$c290 = peg$anyExpectation(),
      peg$c291 = peg$otherExpectation("whitespace"),
      peg$c292 = peg$otherExpectation("empty"),
      peg$c293 = "",
      peg$c294 = /^[\t\x0B\f \xA0\uFEFF]/,
      peg$c295 = peg$classExpectation(["\t", "\x0B", "\f", " ", "\xA0", "\uFEFF"], false, false),
  ...
  function peg$parseTypeIntersectionNonRepeatable() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$parse_();
        if (s3 !== peg$FAILED) {
          s4 = peg$parseTypeIntersectionList();
          if (s4 === peg$FAILED) {
            s4 = null;
          }
          if (s4 !== peg$FAILED) {
