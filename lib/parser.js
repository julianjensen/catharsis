...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c7 = function(r, prefix, expr) {
      		return r ? repeatable( nullable(expr, prefix) ) : nullable(expr, prefix);
      	},
      peg$c8 = function(expr, optionalPre, postfix, optionalPost) {
      		...
      		// julianjensen: It makes perfect sense. You don't have to provide it but, if you do, it has to have a value

      		return optionalPre || optionalPost ? optional( nullable(expr, postfix) ) : nullable(expr, postfix);
      	},
      ...
      peg$c14 = function(r, prefix, bte, postfix, opt) {
          	if ( r ) bte = repeatable( bte );
              bte.outerFirst = true;
          	return bte;
          },
      peg$c15 = function(bte, sep, rst) {
          	return {
              	type: sep === '&' ? Types.TypeIntersection : Types.TypeUnion,
                  outer: true,
                  elements: [ bte, ...rst.elements ]
              };
          },
      peg$c16 = function(bte) { return bte; },
      peg$c17 = function(outer) {
          	return outer;
          },
      peg$c18 = function(outer) { return outer; },
      peg$c19 = function(prefix, expr) {
      		prefix = prefix || '';

      		return nullable(expr, prefix);
      	},
      peg$c20 = function(expr, postfix) {
      		postfix = postfix || '';
      ...
      peg$c37 = function(name, brackets) {
      		var result;
      ...
      peg$c52 = function(sep, l) {
      		return l;
      	},
      peg$c53 = ",",
      peg$c54 = peg$literalExpectation(",", false),
      peg$c55 = function(expr, list) {
      		var result = [expr];
      ...
      //				params: []
      		...
      		Object.keys( Object.getOwnPropertyDescriptors(sig) ).forEach(function(key) {
      			result[key] = sig[key];
      			if ( result.result )
      			{
      			    define( result.result, 'FunctionTypeNonRepeatable', opt );
                      if ( result.result.optional )
                      {
                          delete result.result.optional;
                          opt = true;
                      }
      			}
      ...
      peg$c61 = function(sig, returns) {
      		...
      		if (returns && returns[3]) {
      			...
      			define( result.result, 'FunctionSignatureType', returns[ 3 ].optional );
      		}

      		return result;
      	},
      peg$c62 = function(funcNew, funcThis, params) {
      		var result = {
      ...
      peg$c63 = function(funcThis, funcNew, params) {
      		var result = {
      			params: params ? params[3] : [],
      			'this': funcThis
      		};
      ...
      peg$c65 = "new",
      peg$c66 = peg$literalExpectation("new", false),
      ...
      peg$c74 = function(paramType) { return paramType; },
      peg$c75 = function(t) {
      		t = optional(t);
      		return t;
      	},
      peg$c76 = function(t) {
      		return repeatable(t || { type: Types.NullLiteral });
      	},
      peg$c77 = function() {
      		return repeatable({ type: Types.NullLiteral });
      	},
      peg$c78 = function(t, opt) {
      		var result = {
      			type: Types.TypeUnion,
      			elements: t[ 0 ].type === Types.TypeUnion ? t[ 0 ].elements : t
      		};
      ...
      peg$c80 = function(expr, list) {
      		var result = [expr];
      //        if ( list.type === Types.TypeUnion ) list = list.elements;
      		for (var i = 0, l = list.length; i < l; i++) {
      			result.push(list[i][1]);
      		}
      		return result;
      	},
      peg$c81 = function(expr, list) {
      		var result = [expr];
      //        if ( list.type === Types.TypeUnion ) list = list.elements;
      ...
      peg$c82 = function(rep, list) {
      		const r = {
      			type: Types.TypeUnion,
      			elements: list[ 0 ].type === Types.TypeUnion ? list[ 0 ].elements : list
      		};
      ...
      peg$c86 = function(t, opt) {
      		var result = {
      			type: Types.TypeIntersection,
      			elements: t[ 0 ].type === Types.TypeIntersection ? t[ 0 ].elements : t
      		};
      ...
      peg$c87 = function(expr, list) {
      		var result = [expr];
      //        if ( list.type === Types.TypeIntersection ) list = list.elements;
      		for (var i = 0, l = list.length; i < l; i++) {
      			result.push(list[i][1]);
      		}
      		return result;
      	},
      peg$c88 = function(expr, list) {
      		var result = [expr];
      ...
      peg$c102 = "module:",
      peg$c103 = peg$literalExpectation("module:", false),
      peg$c104 = function(id, props) {
      	    return {
                  name: 'module:' + id + ( props || '' )
      	    };
      	},
      peg$c105 = function(id, props) {
      		props = props || '';
      ...
      peg$c116 = function(name) { return name; },
      peg$c117 = "$",
      ...
      peg$c137 = "continue",
      peg$c138 = peg$literalExpectation("continue", false),
      peg$c139 = "debugger",
      peg$c140 = peg$literalExpectation("debugger", false),
      peg$c141 = "default",
      peg$c142 = peg$literalExpectation("default", false),
      peg$c143 = "delete",
      peg$c144 = peg$literalExpectation("delete", false),
      peg$c145 = "do",
      peg$c146 = peg$literalExpectation("do", false),
      peg$c147 = "else",
      peg$c148 = peg$literalExpectation("else", false),
      peg$c149 = "finally",
      peg$c150 = peg$literalExpectation("finally", false),
      peg$c151 = "for",
      peg$c152 = peg$literalExpectation("for", false),
      peg$c153 = "if",
      peg$c154 = peg$literalExpectation("if", false),
      peg$c155 = "in",
      peg$c156 = peg$literalExpectation("in", false),
      peg$c157 = "instanceof",
      peg$c158 = peg$literalExpectation("instanceof", false),
      peg$c159 = "return",
      peg$c160 = peg$literalExpectation("return", false),
      peg$c161 = "switch",
      peg$c162 = peg$literalExpectation("switch", false),
      peg$c163 = "throw",
      peg$c164 = peg$literalExpectation("throw", false),
      peg$c165 = "try",
      peg$c166 = peg$literalExpectation("try", false),
      peg$c167 = "typeof",
      peg$c168 = peg$literalExpectation("typeof", false),
      peg$c169 = "var",
      peg$c170 = peg$literalExpectation("var", false),
      peg$c171 = "void",
      peg$c172 = peg$literalExpectation("void", false),
      peg$c173 = "while",
      peg$c174 = peg$literalExpectation("while", false),
      peg$c175 = "with",
      peg$c176 = peg$literalExpectation("with", false),
      peg$c177 = function(kw) {
      		return kw;
      	},
      peg$c178 = "class",
      ...
      peg$c182 = "enum",
      peg$c183 = peg$literalExpectation("enum", false),
      peg$c184 = "export",
      peg$c185 = peg$literalExpectation("export", false),
      peg$c186 = "extends",
      peg$c187 = peg$literalExpectation("extends", false),
      peg$c188 = "import",
      peg$c189 = peg$literalExpectation("import", false),
      peg$c190 = "super",
      peg$c191 = peg$literalExpectation("super", false),
      peg$c192 = "implements",
      peg$c193 = peg$literalExpectation("implements", false),
      peg$c194 = "interface",
      peg$c195 = peg$literalExpectation("interface", false),
      peg$c196 = "let",
      peg$c197 = peg$literalExpectation("let", false),
      peg$c198 = "package",
      peg$c199 = peg$literalExpectation("package", false),
      peg$c200 = "private",
      peg$c201 = peg$literalExpectation("private", false),
      peg$c202 = "protected",
      peg$c203 = peg$literalExpectation("protected", false),
      peg$c204 = "public",
      peg$c205 = peg$literalExpectation("public", false),
      peg$c206 = "static",
      peg$c207 = peg$literalExpectation("static", false),
      peg$c208 = "yield",
      peg$c209 = peg$literalExpectation("yield", false),
      peg$c210 = function(frw) {
      		return frw;
      	},
      peg$c211 = "\"",
      peg$c212 = peg$literalExpectation("\"", false),
      peg$c213 = function(str) {
      		return str;
      	},
      peg$c214 = "'",
      peg$c215 = peg$literalExpectation("'", false),
      peg$c216 = function(lit, digits, exp) {
      		return parseFloat(lit + '.' + (digits || '') + (exp || ''));
      	},
      peg$c217 = function(digits, exp) {
      		return parseFloat('.' + digits + (exp || ''));
      	},
      peg$c218 = function(lit, exp) {
      		return parseFloat(lit + (exp || ''));
      	},
      peg$c219 = "0",
      peg$c220 = peg$literalExpectation("0", false),
      peg$c221 = /^[eE]/,
      peg$c222 = peg$classExpectation(["e", "E"], false, false),
      peg$c223 = /^[+\-]/,
      ...
      peg$c228 = "null",
      peg$c229 = peg$literalExpectation("null", false),
      peg$c230 = "undefined",
      ...
      peg$c239 = "function",
      peg$c240 = peg$literalExpectation("function", false),
      peg$c241 = "\\",
      peg$c242 = peg$literalExpectation("\\", false),
      peg$c243 = "u",
      peg$c244 = peg$literalExpectation("u", false),
      peg$c245 = function(hex) {
      ...
      peg$c292 = "\r\n",
      peg$c293 = peg$literalExpectation("\r\n", false),
      peg$c294 = function() {
      		return '0';
      	},
      peg$c295 = /^['"\\bfnrtv]/,
      peg$c296 = peg$classExpectation(["'", "\"", "\\", "b", "f", "n", "r", "t", "v"], false, false),
      peg$c297 = "x",
      peg$c298 = peg$literalExpectation("x", false),
      peg$c299 = peg$anyExpectation(),
      peg$c300 = peg$otherExpectation("whitespace"),
      peg$c301 = peg$otherExpectation("empty"),
      peg$c302 = "",
      peg$c303 = /^[\t\x0B\f \xA0\uFEFF]/,
      peg$c304 = peg$classExpectation(["\t", "\x0B", "\f", " ", "\xA0", "\uFEFF"], false, false),
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s0 === peg$FAILED) {
          ...
          if (s0 === peg$FAILED) {
            ...
            if (s0 === peg$FAILED) {
              s0 = peg$parseTypeIntersectionLegacySyntax();
            }
          }
        }
      }
  ...
  function peg$parseReturnTypeExpression() {
  ...
  function peg$parseBasicTypeExpression() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          s4 = peg$parse_();
          if (s4 !== peg$FAILED) {
            s5 = peg$parsePBasicTypeExpression();
            if (s5 !== peg$FAILED) {
              s6 = peg$parse_();
              if (s6 !== peg$FAILED) {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$parse_();
        if (s3 !== peg$FAILED) {
          s4 = peg$parsePBasicTypeExpression();
          if (s4 !== peg$FAILED) {
            s5 = peg$parse_();
            if (s5 !== peg$FAILED) {
              if (input.charCodeAt(peg$currPos) === 41) {
              ...
              if (s6 !== peg$FAILED) {
                ...
                if (s7 !== peg$FAILED) {
                  ...
                  if (s8 !== peg$FAILED) {
                    s9 = peg$parse_();
                    if (s9 !== peg$FAILED) {
                      s10 = peg$parseTypeUnionLegacySyntax();
                      if (s10 === peg$FAILED) {
                        s10 = peg$parseTypeIntersectionLegacySyntax();
                      }
                      if (s10 !== peg$FAILED) {
                        peg$savedPos = s1;
                        s2 = peg$c15(s4, s8, s10);
                        s1 = s2;
                      } else {
                        peg$currPos = s1;
                        s1 = peg$FAILED;
      ...
      if (s1 === peg$FAILED) {
        s1 = peg$currPos;
        s2 = peg$parsePBasicTypeExpression();
        if (s2 !== peg$FAILED) {
          peg$savedPos = s1;
          s2 = peg$c16(s2);
        }
  ...
  function peg$parsePBasicTypeExpression() {
    var s0;
  ...
  function peg$parseBasicTypeExpressionNonRepeatable() {
    ...
    if (s2 !== peg$FAILED) {
      s3 = peg$parse_();
      if (s3 !== peg$FAILED) {
        s4 = peg$parsePBasicTypeExpressionNonRepeatable();
        if (s4 !== peg$FAILED) {
          s5 = peg$parse_();
          if (s5 !== peg$FAILED) {
            if (input.charCodeAt(peg$currPos) === 41) {
    ...
    if (s1 === peg$FAILED) {
      s1 = peg$currPos;
      s2 = peg$parsePBasicTypeExpressionNonRepeatable();
      if (s2 !== peg$FAILED) {
        peg$savedPos = s1;
        s2 = peg$c16(s2);
      }
  ...
  function peg$parsePBasicTypeExpressionNonRepeatable() {
    var s0;
    ...
    if (s0 === peg$FAILED) {
      s0 = peg$parseTypeIntersectionNonRepeatable();
      if (s0 === peg$FAILED) {
        s0 = peg$parseTypeTupleNonRepeatable();
        if (s0 === peg$FAILED) {
  ...
  function peg$parseTypeTuple() {
    ...
    s0 = peg$parseTypeTupleRepeatable();
    if (s0 === peg$FAILED) {
      s0 = peg$parseTypeTupleNonRepeatable();
    }
  ...
  function peg$parseTypeTupleNonRepeatable() {
    var s0, s1, s2, s3, s4, s5, s6;
  ...
  function peg$parseTypeTupleRepeatable() {
    var s0, s1, s2;
    ...
    s1 = peg$parseRepeatable();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseTypeTupleNonRepeatable();
      if (s2 !== peg$FAILED) {
        peg$savedPos = s0;
        s1 = peg$c44(s2);
        s0 = s1;
              ...
              if (s6 !== peg$FAILED) {
                ...
                if (s8 !== peg$FAILED) {
                  ...
                  if (s9 !== peg$FAILED) {
                    s10 = peg$parse_();
                    if (s10 !== peg$FAILED) {
                      s11 = peg$parseReturnTypeExpression();
                      if (s11 !== peg$FAILED) {
                        s8 = [s8, s9, s10, s11];
                        s7 = s8;
                      } else {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          s4 = peg$parse_();
          if (s4 !== peg$FAILED) {
            s5 = peg$parseRestrictedTypeUnionList();
            if (s5 !== peg$FAILED) {
              s6 = peg$parse_();
              if (s6 !== peg$FAILED) {
                s7 = peg$currPos;
  ...
  function peg$parseTypeIntersection() {
    var s0;
    ...
    s0 = peg$parseTypeIntersectionRepeatable();
    if (s0 === peg$FAILED) {
      s0 = peg$parseTypeIntersectionNonRepeatable();
    }
  ...
  function peg$parseTypeIntersectionNonRepeatable() {
    var s0, s1, s2, s3, s4, s5, s6, s7;
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$parse_();
        if (s3 !== peg$FAILED) {
          s4 = peg$parseRestrictedTypeIntersectionList();
          if (s4 === peg$FAILED) {
            s4 = null;
          }
          if (s4 !== peg$FAILED) {
  ...
  function peg$parseTypeIntersectionRepeatable() {
    var s0, s1, s2;
    ...
    s1 = peg$parseRepeatable();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseTypeIntersectionNonRepeatable();
      if (s2 !== peg$FAILED) {
        peg$savedPos = s0;
        s1 = peg$c79(s2);
        s0 = s1;
  ...
  function peg$parseTypeIntersectionList() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parseTypeIntersectionSeparator();
      if (s4 !== peg$FAILED) {
        s5 = peg$parseTypeExpression();
        if (s5 !== peg$FAILED) {
          s4 = [s4, s5];
  ...
  function peg$parseRestrictedTypeIntersectionList() {
    var s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseTypeIntersectionLegacySyntax() {
    var s0, s1, s2, s3, s4, s5, s6, s7;
  ...
  function peg$parseTypeIntersectionSeparator() {
    var s0, s1, s2, s3;
  ...
  var Types = {
      ...
      {
          Object.defineProperty( o, n, { enumerable: false, value: v } );
      }
